...
# i need to 🔅select over the array
# i'll select the item which 🔅count is > to 1
# i'll return the 🔅first item inside the array 


def find_dup(arr)
  arr.select { |item| arr.count(item) == 2 }.first
end
